...
| ------------- | --------------------------------- |
| loyer projeté | `projectedRentalIncome` (positif) |
...
| `avoidedAirConditioningCo2eqEmissions`              | Friche /Urbain / Fraîcheur | +             |
| `avoidedAirConditioningExpenses`                    | Friche /Urbain / Fraîcheur | +             |
| `avoidedPropertyDamageExpenses`                     | Friche /Urbain / Mobilité  | +             |
| `avoidedCarRelatedExpenses`                         | Friche /Urbain / Mobilité  | +             |
| `travelTimeSavedPerTravelerExpenses`                | Friche /Urbain / Mobilité  | +             |
| `avoidedTrafficCo2EqEmissions`                      | Friche /Urbain / Mobilité  | +             |
| `avoidedAirPollutionHealthExpenses`                 | Friche /Urbain / Mobilité  | +             |
| `avoidedAccidentsMinorInjuriesExpenses`             | Friche /Urbain / Mobilité  | +             |
| `avoidedAccidentsSevereInjuriesExpenses`            | Friche /Urbain / Mobilité  | +             |
| `avoidedAccidentsDeathsExpenses`                    | Friche /Urbain / Mobilité  | +             |
