...
export class YearlyTravelRelatedImpacts extends InfluenceAreaService {
  ...
  protected get avoidedMinorInjuriesPerYear() {
    return Math.floor(this.avoidedAccidentsPerYear * this.minorInjuriesRatioPerAccident);
  }

  protected get avoidedSevereInjuriesPerYear() {
    return Math.floor(this.avoidedAccidentsPerYear * this.severeInjuriesRatioPerAccident);
  }

  protected get avoidedDeathsPerYear() {
    return Math.floor(this.avoidedAccidentsPerYear * this.deathsRatioPerAccident);
  }
