...
import { RevokeUnusedAuthTokensUseCase } from "../core/revokeUnusedAuthTokens.usecase";
...
@Module({
  ...
  providers: [
    ...
    {
      provide: RevokeUnusedAuthTokensUseCase,
      useFactory: (
        tokenAuthAttemptRepository: TokenAuthenticationAttemptRepository,
        dateProvider: DateProvider,
      ) =>
        new RevokeUnusedAuthTokensUseCase(
          tokenAuthAttemptRepository,
          dateProvider,
          new NestJsAppLogger("RevokeUnusedAuthTokens"),
        ),
  ...
  exports: [ACCESS_TOKEN_SERVICE_INJECTION_TOKEN, RevokeUnusedAuthTokensUseCase],
})
