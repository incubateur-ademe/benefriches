...
describe("PermeableSurfaceArea impact", () => {
  ...
  it("returns positive difference when more mineral soils in forecast", () => {
  ...
  it("returns positive difference when more green soils in forecast", () => {
    const baseSoilsDistribution: SoilsDistribution = {
      IMPERMEABLE_SOILS: 200,
      BUILDINGS: 100,
      ARTIFICIAL_GRASS_OR_BUSHES_FILLED: 100,
  ...
  it("returns positive difference when more green and mineral soils in forecast", () => {
    const baseSoilsDistribution: SoilsDistribution = {
      IMPERMEABLE_SOILS: 200,
      BUILDINGS: 100,
      ARTIFICIAL_GRASS_OR_BUSHES_FILLED: 100,
  ...
  it("returns negative difference when everything is impermeable in forecast", () => {
    const baseSoilsDistribution: SoilsDistribution = {
      IMPERMEABLE_SOILS: 200,
      BUILDINGS: 100,
      ARTIFICIAL_GRASS_OR_BUSHES_FILLED: 100,
