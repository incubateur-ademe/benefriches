    ...
    <div className="tw-flex tw-flex-col tw-items-center tw-py-8">
      ...
      >
        <div className="tw-relative tw-inline-flex">
          <div className="tw-w-8 tw-h-8 tw-bg-blue tw-rounded-full"></div>
          <div className="tw-w-8 tw-h-8 tw-bg-blue tw-rounded-full tw-absolute tw-top-0 tw-left-0 tw-animate-ping"></div>
