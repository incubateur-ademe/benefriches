...
export default function Section({ children, title, tooltip, buttonProps, warning }: Props) {
    ...
    <section className="mb-10">
      <div
        className={classNames(
          "flex flex-col px-2",
          warning && "bg-warning-ultralight dark:bg-warning-ultradark",
        )}
      >
        ...
        {warning && (
          <span className="pb-2 dark:text-warning-ultralight text-warning-ultradark ">
            {warning}
          </span>
        )}
      </div>
