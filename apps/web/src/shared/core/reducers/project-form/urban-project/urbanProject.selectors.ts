...
export const createUrbanProjectFormSelectors = (
  ...
  const selectBuildingsFootprintToReuseViewData = createSelectBuildingsFootprintToReuseViewData(
    selectStepState,
    selectors.selectSiteSoilsDistribution,
  );
  const selectBuildingsDemolitionInfoViewData = createSelectBuildingsDemolitionInfoViewData(
    selectStepState,
  ...
  const selectNewBuildingsUsesFloorSurfaceAreaViewData =
    createSelectNewBuildingsUsesFloorSurfaceAreaViewData(selectStepState);
  ...
  return {
    ...
    selectNewBuildingsUsesFloorSurfaceAreaViewData,
