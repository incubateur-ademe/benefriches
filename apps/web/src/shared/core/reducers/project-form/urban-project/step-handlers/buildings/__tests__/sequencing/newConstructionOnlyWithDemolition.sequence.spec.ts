...
describe("Urban project buildings sequencing - new construction only with demolition", () => {
  ...
  it("URBAN_PROJECT_BUILDINGS_INTRODUCTION -> URBAN_PROJECT_BUILDINGS_USES_FLOOR_SURFACE_AREA -> URBAN_PROJECT_BUILDINGS_REUSE_INTRODUCTION -> URBAN_PROJECT_BUILDINGS_FOOTPRINT_TO_REUSE -> URBAN_PROJECT_BUILDINGS_DEMOLITION_INFO -> URBAN_PROJECT_BUILDINGS_NEW_CONSTRUCTION_INFO -> URBAN_PROJECT_SITE_RESALE_INTRODUCTION", () => {
