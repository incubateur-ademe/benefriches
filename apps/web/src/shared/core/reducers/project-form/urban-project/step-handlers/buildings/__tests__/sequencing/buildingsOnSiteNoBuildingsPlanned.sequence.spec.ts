...
describe("Urban project buildings sequencing - buildings on site, no buildings planned in project", () => {
  ...
  it("URBAN_PROJECT_BUILDINGS_INTRODUCTION -> URBAN_PROJECT_BUILDINGS_USES_FLOOR_SURFACE_AREA -> URBAN_PROJECT_BUILDINGS_REUSE_INTRODUCTION -> URBAN_PROJECT_BUILDINGS_FOOTPRINT_TO_REUSE -> URBAN_PROJECT_BUILDINGS_DEMOLITION_INFO -> URBAN_PROJECT_SITE_RESALE_INTRODUCTION", () => {
  ...
  it("URBAN_PROJECT_BUILDINGS_INTRODUCTION -> URBAN_PROJECT_BUILDINGS_USES_FLOOR_SURFACE_AREA -> URBAN_PROJECT_BUILDINGS_REUSE_INTRODUCTION -> URBAN_PROJECT_BUILDINGS_FOOTPRINT_TO_REUSE -> URBAN_PROJECT_BUILDINGS_DEMOLITION_INFO -> URBAN_PROJECT_SOILS_DECONTAMINATION_INTRODUCTION", () => {
    const store = new StoreBuilder()
      .withCurrentStep("URBAN_PROJECT_BUILDINGS_INTRODUCTION")
      .withSiteData({
        soilsDistribution: { ...mockSiteData.soilsDistribution, BUILDINGS: 2000 },
