...
export const SOCIAL_METRICS_MODALS = {
  social: {
    ...
    ContentComponent: () => import("../mdx-component/social_section.mdx"),
  },
  jobs: {
    title: "Impacts sur l'emploi",
    ContentComponent: () => import("../mdx-component/social_jobs_section.mdx"),
  },
  ...
  avoidedVehiculeKilometers: {
    ...
    unit: "kms",
    ContentComponent: () => import("../mdx-component/avoided_vehicule_kilometers.mdx"),
  },
  fullTimeJobs: {
    title: "🧑‍🔧 Emplois équivalent temps plein",
    type: "etp",
    formatFn: formatETPImpact,
    ContentComponent: () => import("../mdx-component/full-time-jobs/full_time_jobs.mdx"),
  },
  ...
  householdsPoweredByRenewableEnergy: {
    ...
    ContentComponent: () => import("../mdx-component/households_powered_by_enr.mdx"),
  },
  timeTravelSavedInHours: {
    title: "⏱️ Temps passé en moins dans les transports",
    unit: "h",
    description: "pour la population locale",
    ContentComponent: () => import("../mdx-component/travel_time_saved.mdx"),
  },
