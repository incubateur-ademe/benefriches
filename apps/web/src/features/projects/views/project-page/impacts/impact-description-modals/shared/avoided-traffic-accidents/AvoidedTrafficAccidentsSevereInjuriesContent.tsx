...
const AvoidedTrafficAccidentsSevereInjuriesContent = ({ withMonetarisation }: Props) => {
  return (
    <>
      ...
      <ul>
        ...
        {withMonetarisation && <li>Valeur du coût d’un blessé grave (exprimée en €/unité)</li>}

        <li>Nombre de blessés graves par accident (exprimé en unité/100accidents)</li>
        <li>
      ...
      <ul>
        ...
        <li>
          un taux de blessés graves par accident (exprimé en nombre de blessés graves pour 100
      ...
      <p>Le nombre de blessés graves évités est égal au produit entre ces 3 paramètres. </p>
      {withMonetarisation && (
        <p>
          Le calcul économique consiste à multiplier ce nombre de blessés à la valeur du coût d’un
          blessé grave (exprimée en €/unité).
        </p>
      )}
...
export default AvoidedTrafficAccidentsSevereInjuriesContent;
