    ...
    <>
      ...
      <ModalContent>
        <p>
          ...
          projet. La bibliographie met en évidence un effet positif engendré par la suppression
          d’une friche polluée pour les riverains et ce, d’autant plus que l’espace crée est un
          espace de nature.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            Périmètre d'influence du projet de reconversion sur les valeurs immobilières&nbsp;: 200
            m
          </li>
          <li>
        ...
        <p>
          L’impact économique de la reconversion sur les valeurs immobilières est calculé en
          plusieurs étapes :
        </p>
        <ul>
          <li>
            Calcul de la surface de logements (exprimée en m²) présente dans le périmètre
            d’influence du projet de reconversion&nbsp;: cette surface est égale au produit des 3
            valeurs suivantes (i) la densité de population locale, (ii) le nombre moyen de m² de
            logement par habitant correspondante et (iii) aire présente dans le périmètre
            d’influence du projet (considéré comme un disque). Ce calcul est fait en excluant les
            logements sociaux.
          </li>
          <li>
            Pour chaque tranche de taux d’effet du projet de reconversion sur les valeurs
            immobilières, calcul de la valeur patrimoniale (exprimée en €) des logements présents
            dans le périmètre d’influence&nbsp;: cette valeur est le produit de la valeur
            immobilière des logements par la surface de logement calculée préalablement.
          </li>
          <li>
            Pour chaque tranche de taux d’effet du projet de reconversion sur les valeurs
            immobilières, calcul de l’augmentation de valeur patrimoniale (exprimée en €) pouvant
            être attendu du fait de la réalisation du projet par application du taux d’effet
            correspondant.
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            ...
            <ExternalLink href="https://www.cairn.info/revue-d-economie-regionale-et-urbaine-2001-4-page-605.htm">
              ...
              l'arrondissement de Lens (Nord – Pas de Calais), Revue d'économie régionale et
          ...
          <li>
            ...
            <ExternalLink href="https://www.statistiques.developpement-durable.gouv.fr/sites/default/files/2018-10/Chiffres_stats%20343.pdf">
              Les conditions d’occupation des logements au 1er janvier 2011, Chiffres et
