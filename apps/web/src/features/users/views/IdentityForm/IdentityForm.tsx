...
type Props = {
  saveIdentityLoadingState: "idle" | "loading" | "success" | "error";
  onSubmit: (data: FormValues) => void;
};

function IdentityForm({ onSubmit, saveIdentityLoadingState }: Props) {
    ...
    <WizardFormLayout title="Avant de commencer...">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Input
          ...
          stateRelatedMessage={formState.errors.email ? formState.errors.email.message : undefined}
          nativeInputProps={{
        ...
        <div className={fr.cx("fr-grid-row")}>
          <Select
            ...
            state={formState.errors.structureType ? "error" : "default"}
            stateRelatedMessage={
              formState.errors.structureType ? formState.errors.structureType.message : undefined
            }
            nativeSelectProps={{
            ...
            options={[
              { label: "Promoteur", value: "promoter" },
              { label: "Bailleur social", value: "local_authority_landlord" },
              { label: "Collectivité", value: "community" },
              {
                label: "Développeur de centrale photovoltaïque",
                value: "photovoltaic_plants_developer",
              },
              { label: "Industriel", value: "industrialist" },
        ...
        />
        {saveIdentityLoadingState === "error" && (
          <Alert
        ...
        <ButtonsGroup
          ...
          buttons={[
            {
              children: saveIdentityLoadingState === "loading" ? "Chargement..." : "Commencer",
              type: "submit",
              disabled: saveIdentityLoadingState === "loading",
            },
            {
