  ...
  return (
    <>
      ...
      <p>
        ...
        <strong>projets d'aménagment</strong> sur ce site.
      </p>
      <h2>Documents utiles</h2>
      <p>
        Pour vous aider à saisir les informations liées au site, nous vous conseillons de mobiliser
      ...
      <p>
        ...
        Bénéfriches vous proposant des valeurs par défaut, issues du retour d'expérience de l'ADEME
        ou autres ressources documentaires.
      </p>
      <p>
        Néanmoins, plus les données renseignées seront spécifiques, plus les résultats seront
        pertinents et fiables !
      </p>
      <Button linkProps={routes.createSiteFoncier().link}>Saisir les informations</Button>
    </>
  );
}
