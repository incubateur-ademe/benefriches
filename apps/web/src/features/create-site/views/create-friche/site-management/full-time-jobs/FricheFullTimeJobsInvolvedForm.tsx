...
function FricheFullTimeJobsInvolvedForm({ onSubmit }: Props) {
  ...
  return (
    <>
      <h2>
        Combien d'emplois équivalent temps-plein sont mobilisés sur la friche ?
      </h2>
...
export default FricheFullTimeJobsInvolvedForm;
