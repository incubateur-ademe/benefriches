...
const SITE_CREATION_STEP_ROUTE_QUERY_STRING_MAP = {
  ...
  URBAN_ZONE_LAND_PARCEL_SOILS_SELECTION: "zone-urbaine-selection-sols-surfaces-foncieres",
  URBAN_ZONE_LAND_PARCEL_SOILS_DISTRIBUTION: "zone-urbaine-superficie-sols-surfaces-foncieres",
