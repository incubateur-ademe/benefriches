import { buildingsDemolitionInfoStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/buildings/buildings-demolition-info/buildingsDemolitionInfo.stepperConfig";
import { buildingsFootprintToReuseStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/buildings/buildings-footprint-to-reuse/buildingsFootprintToReuse.stepperConfig";
import { buildingsIntroductionStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/buildings/buildings-introduction/buildingsIntroduction.stepperConfig";
import { buildingsNewConstructionInfoStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/buildings/buildings-new-construction-info/buildingsNewConstructionInfo.stepperConfig";
import { buildingsNewConstructionIntroductionStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/buildings/buildings-new-construction-introduction/buildingsNewConstructionIntroduction.stepperConfig";
import { buildingsReuseIntroductionStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/buildings/buildings-reuse-introduction/buildingsReuseIntroduction.stepperConfig";
import { buildingsUsesFloorSurfaceAreaStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/buildings/buildings-uses-floor-surface-area/buildingsUsesFloorSurfaceArea.stepperConfig";
import { buildingsExistingBuildingsUsesFloorSurfaceAreaStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/buildings/existing-buildings-uses-floor-surface-area/existingBuildingsUsesFloorSurfaceArea.stepperConfig";
import { buildingsNewBuildingsUsesFloorSurfaceAreaStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/buildings/new-buildings-uses-floor-surface-area/newBuildingsUsesFloorSurfaceArea.stepperConfig";
import { expensesBuildingsConstructionAndRehabilitationStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/expenses/expenses-buildings-construction-and-rehabilitation/expensesBuildingsConstructionAndRehabilitation.stepperConfig";
import { expensesInstallationStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/expenses/expenses-installation/expensesInstallation.stepperConfig";
import { expensesIntroductionStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/expenses/expenses-introduction/expensesIntroduction.stepperConfig";
import { expensesProjectedBuildingsOperatingExpensesStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/expenses/expenses-projected-buildings-operating-expenses/expensesProjectedBuildingsOperatingExpenses.stepperConfig";
import { expensesReinstatementStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/expenses/expenses-reinstatement/expensesReinstatement.stepperConfig";
import { expensesSitePurchaseAmountsStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/expenses/expenses-site-purchase-amounts/expensesSitePurchaseAmounts.stepperConfig";
import { namingStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/naming/naming/naming.stepperConfig";
import { creationResultStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/result/creation-result/creationResult.stepperConfig";
import { revenueBuildingsOperationsYearlyRevenuesStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/revenues/revenue-buildings-operations-yearly-revenues/revenueBuildingsOperationsYearlyRevenues.stepperConfig";
import { revenueBuildingsResaleStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/revenues/revenue-buildings-resale/revenueBuildingsResale.stepperConfig";
import { revenueExpectedSiteResaleStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/revenues/revenue-expected-site-resale/revenueExpectedSiteResale.stepperConfig";
import { revenueFinancialAssistanceStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/revenues/revenue-financial-assistance/revenueFinancialAssistance.stepperConfig";
import { revenueIntroductionStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/revenues/revenue-introduction/revenueIntroduction.stepperConfig";
import { scheduleProjectionStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/schedule/schedule-projection/scheduleProjection.stepperConfig";
import { buildingsResaleSelectionStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/site-and-buildings-resale/buildings-resale-selection/buildingsResaleSelection.stepperConfig";
import { siteResaleIntroductionStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/site-and-buildings-resale/site-resale-introduction/siteResaleIntroduction.stepperConfig";
import { siteResaleSelectionStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/site-and-buildings-resale/site-resale-selection/siteResaleSelection.stepperConfig";
...
import { spacesIntroductionStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/spaces/spaces-introduction/spacesIntroduction.stepperConfig";
import { spacesSelectionStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/spaces/spaces-selection/spacesSelection.stepperConfig";
import { spacesSurfaceAreaStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/spaces/spaces-surface-area/spacesSurfaceArea.stepperConfig";
import { stakeholdersBuildingsDeveloperStepperConfig } from "@/features/create-project/core/urban-project/step-handlers/stakeholders/stakeholders-buildings-developer/stakeholdersBuildingsDeveloper.stepperConfig";
