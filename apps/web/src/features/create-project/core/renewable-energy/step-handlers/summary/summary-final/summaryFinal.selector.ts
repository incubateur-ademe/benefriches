...
type FinalSummaryViewData = {
  projectData: {
    ...
    soilsCarbonStorage?: RenewableEnergyProjectState["soilsCarbonStorage"]["projected"];
    futureOwner?: string;
  ...
  siteData: {
    surfaceArea: number;
    soilsDistribution: SoilsDistribution;
    soilsCarbonStorage?: RenewableEnergyProjectState["soilsCarbonStorage"]["current"];
    name: string;
  };
};

export const createSelectPhotovoltaicFinalSummaryViewData = (
  ...
  createSelector(
    ...
    (steps, siteData, soilsCarbonStorage, soilsDistribution): FinalSummaryViewData => {
      ...
      const surface = ReadStateHelper.getStepAnswers(
        steps,
