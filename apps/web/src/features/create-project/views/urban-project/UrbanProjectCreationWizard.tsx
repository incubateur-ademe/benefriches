...
const PROJECT_CREATION_STEP_QUERY_STRING_MAP = {
  ...
  BUILDINGS_USE_INTRODUCTION: "introduction-usages-batiments",
  BUILDINGS_USE_SURFACE_AREA_DISTRIBUTION: "surfaces-usages-batiments",
  ...
  SITE_RESALE_SELECTION: "cession-fonciere-prevue",
  BUILDINGS_RESALE_SELECTION: "cession-batiments-prevue",
  ...
  REVENUE_EXPECTED_SITE_RESALE: "recettes-cession-site",
  REVENUE_BUILDINGS_RESALE: "recettes-cession-batiments",
