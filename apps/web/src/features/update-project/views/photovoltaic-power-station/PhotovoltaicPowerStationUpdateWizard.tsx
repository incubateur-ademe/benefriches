      ...
      {(() => {
        switch (currentStep) {
          case "RENEWABLE_ENERGY_STAKEHOLDERS_INTRODUCTION":
            return (
              <>
                <HtmlTitle>{`Introduction - Acteurs - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_STAKEHOLDERS_PROJECT_DEVELOPER":
            return (
              <>
                <HtmlTitle>{`Aménageur - Acteurs - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
                <DeveloperForm />
              </>
            );
          case "RENEWABLE_ENERGY_STAKEHOLDERS_FUTURE_OPERATOR":
            return (
              <>
                <HtmlTitle>{`Futur exploitant - Acteurs - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
                <SiteOperatorForm />
              </>
            );
          case "RENEWABLE_ENERGY_STAKEHOLDERS_REINSTATEMENT_CONTRACT_OWNER":
            return (
              <>
                <HtmlTitle>{`Maître d'ouvrage de la réhabilitation - Acteurs - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_STAKEHOLDERS_SITE_PURCHASE":
            return (
              <>
                <HtmlTitle>{`Changement de propriétaire - Acteurs - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_STAKEHOLDERS_FUTURE_SITE_OWNER":
            return (
              <>
                <HtmlTitle>{`Futur propriétaire - Acteurs - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_EXPENSES_INTRODUCTION":
            return (
              <>
                <HtmlTitle>{`Introduction - Dépenses - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_EXPENSES_REINSTATEMENT":
            return (
              <>
                <HtmlTitle>{`Remise en état - Dépenses - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_EXPENSES_SITE_PURCHASE_AMOUNTS":
            return (
              <>
                <HtmlTitle>{`Achat du site - Dépenses - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_EXPENSES_PHOTOVOLTAIC_PANELS_INSTALLATION":
            return (
              <>
                <HtmlTitle>{`Installation des panneaux - Dépenses - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_EXPENSES_PROJECTED_YEARLY_EXPENSES":
            return (
              <>
                <HtmlTitle>{`Exploitation - Dépenses - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_REVENUE_INTRODUCTION":
            return (
              <>
                <HtmlTitle>{`Introduction - Revenus - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_REVENUE_PROJECTED_YEARLY_REVENUE":
            return (
              <>
                <HtmlTitle>{`Exploitation - Revenus - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_REVENUE_FINANCIAL_ASSISTANCE":
            return (
              <>
                <HtmlTitle>{`Aides financières - Revenus - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_NAMING":
            return (
              <>
                <HtmlTitle>{`Dénomination - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_PHOTOVOLTAIC_KEY_PARAMETER":
            return (
              <>
                <HtmlTitle>{`Sélection - Paramètres - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_PHOTOVOLTAIC_POWER":
            return (
              <>
                <HtmlTitle>{`Puissance - Paramètres - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
                <PhotovoltaicPower />
              </>
            );
          case "RENEWABLE_ENERGY_PHOTOVOLTAIC_SURFACE":
            return (
              <>
                <HtmlTitle>{`Surface des panneaux - Paramètres - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
                <PhotovoltaicSurface />
              </>
            );
          case "RENEWABLE_ENERGY_PHOTOVOLTAIC_EXPECTED_ANNUAL_PRODUCTION":
            return (
              <>
                <HtmlTitle>{`Production attendue - Paramètres - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_PHOTOVOLTAIC_CONTRACT_DURATION":
            return (
              <>
                <HtmlTitle>{`Durée du contrat de revente - Paramètres - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_SOILS_TRANSFORMATION_INTRODUCTION":
            return (
              <>
                <HtmlTitle>{`Introduction - Sols - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_NON_SUITABLE_SOILS_NOTICE":
            return (
              <>
                <HtmlTitle>{`Introduction - Alerte - Sols - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_NON_SUITABLE_SOILS_SELECTION":
            return (
              <>
                <HtmlTitle>{`Sélection - Alerte - Sols - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_NON_SUITABLE_SOILS_SURFACE":
            return (
              <>
                <HtmlTitle>{`Surfaces - Alerte - Sols - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_INVOLVES_REINSTATEMENT":
            return (
              <>
                <HtmlTitle>{`Remise en état - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_SOILS_DECONTAMINATION_INTRODUCTION":
            return (
              <>
                <HtmlTitle>{`Introduction - Dépollution - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_SOILS_DECONTAMINATION_SELECTION":
            return (
              <>
                <HtmlTitle>{`Mode de saisie - Dépollution - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_SOILS_DECONTAMINATION_SURFACE_AREA":
            return (
              <>
                <HtmlTitle>{`Surface - Dépollution - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_SOILS_TRANSFORMATION_PROJECT_SELECTION":
            return (
              <>
                <HtmlTitle>{`Sélection - Sols - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_SOILS_TRANSFORMATION_CUSTOM_SOILS_SELECTION":
            return (
              <>
                <HtmlTitle>{`Sélection des catégories - Sols - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_SOILS_TRANSFORMATION_CUSTOM_SURFACE_AREA_ALLOCATION":
            return (
              <>
                <HtmlTitle>{`Répartition des surfaces - Sols - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_SOILS_TRANSFORMATION_CLIMATE_AND_BIODIVERSITY_IMPACT_NOTICE":
            return (
              <>
                <HtmlTitle>{`Alerte climat et biodiversité - Sols - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_SOILS_SUMMARY":
            return (
              <>
                <HtmlTitle>{`Récapitulatif - Sols - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_SOILS_CARBON_STORAGE":
            return (
              <>
                <HtmlTitle>{`Stockage de carbone - Sols - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_SCHEDULE_PROJECTION":
            return (
              <>
                <HtmlTitle>{`Saisie - Calendrier- ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
          ...
          case "RENEWABLE_ENERGY_FINAL_SUMMARY":
            return (
              <>
                <HtmlTitle>{`Récapitulatif - ${HTML_PV_UPDATE_FORM_MAIN_TITLE}`}</HtmlTitle>
                <ProjectUpdateDataSummaryContainer />
              </>
            );
        }
      })()}
