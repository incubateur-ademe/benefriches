...
export default function PreserveSoilsSection() {
  return (
    <section className="fr-container tw-bg-white fr-py-10w">
      <div className="tw-grid md:tw-grid-cols-2">
        <div>
          ...
          <p>
            Ce constat repose sur un prisme d'analyse uniquement fondé sur un bilan économique ; il
            ne prend pas en considération les nombreux <strong>effets et retombées positifs</strong>{" "}
            que la réalisation d'un projet d'aménagement sur une friche génère à court, moyen et
            long terme (ex : amélioration de l'attractivité d'un quartier, réduction du besoin en
            infrastructures et en déplacements et effets GES associés, maintien de capacité de
            stockage de carbone dans les sols, etc.)
          </p>
          <p>
          ...
          <p>
            Bénéfriches a été développé pour quantifier et monétariser les impacts socio-économiques
            de la reconversion de friche afin que les acteurs de l'aménagement, au premier rang
            desquels les collectivités,{" "}
