...
- **Target surface**: the full instruction surface (`AGENTS.md` **+ rules + skills**), not
  just `AGENTS.md`.
...
- **Ambiguous instruction that misled** — a rule/AGENTS.md/skill line was followed literally
